...
export default function CriarPainelPage() {
  ...
  const handlePreview = () => {
    ...
    localStorage.setItem('painelPreviewConfig', JSON.stringify(config));

    // Abrir preview em nova aba
    window.open('/painel/preview', '_blank');
  };
              ...
              {activeTab === 'basico' && (
                <>
                  ...
                  <ImageUpload
                    ...
                    onChange={(url) => updateConfig({ logoEventoUrl: url })}
                    label="Logo do Evento"
                    description="Este logo aparecerá no cabeçalho do painel"
                  />

                  <ImageUpload
                    value={config.logoPatrocinadorUrl}
                    onChange={(url) => updateConfig({ logoPatrocinadorUrl: url })}
                    label="Logo Patrocinador Exemplo"
                    description="Use para testar o preview com um logo de exemplo"
                  />
                </>
              )}
