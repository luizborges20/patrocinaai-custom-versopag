...
export default function PreviewPage() {
  ...
  useEffect(() => {
    ...
    const savedConfig = localStorage.getItem('painelPreviewConfig');
    if (savedConfig) {
    ...
    if (savedConfig) {
      ...
      loadFont(parsedConfig.fonteTitulo);
      loadFont(parsedConfig.fonteCorpo);
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
        <div className="text-center">
          <div className="text-lg mb-4">Carregando preview...</div>
