...
export default function App() {
  ...
  const onGoToProducerArea = () => {
    console.log("Navegando para área do produtor");
  };
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
        <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-center h-14">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-xs text-gray-500">usuarioteste@gmail.com</span>
                  </div>
                </Button>
            ...
            {/* Menu - Mobile */}
            <Button variant="ghost" className="md:hidden absolute right-4 text-gray-700 hover:text-gray-900 hover:bg-[var(--versopag-accent)]">
